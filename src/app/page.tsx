...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      {/* Navigation */}
      <header className="fixed top-0 left-0 right-0 z-40 bg-white border-b border-[rgba(0,0,0,0.06)]">
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-[980px] mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            <div className="bg-white rounded-[12px] p-8 border border-[rgba(0,0,0,0.06)]">
      ...
      {/* Footer */}
      <footer className="py-8 px-6 bg-white border-t border-[rgba(0,0,0,0.06)]">
        <div className="max-w-[980px] mx-auto">
